...
export const Projects = () => {
  ...
  const renderProjectList = (projList: Project[]) => (
      ...
      {projList.map((project, index) => {
         ...
         return (
          <motion.div
            ...
            viewport={{ once: true }}
            className={`grid md:grid-cols-12 gap-8 md:gap-16 items-center ${index % 2 === 1 ? 'md:flex-row-reverse' : ''}`}
          >
            ...
            <div className={`md:col-span-5 ${index % 2 === 1 ? 'md:order-1' : ''}`}>
              ...
              <p className="text-lg text-brand-brown/70 mb-8 italic leading-relaxed">"{project.description}"</p>
        ...
        <div className="space-y-24 md:space-y-32">
          <div>
            <div className="mb-10 md:mb-14">
              <p className="text-xs font-bold uppercase tracking-widest text-brand-terracotta">En cours</p>
              <h2 className="text-2xl md:text-4xl font-serif text-brand-brown mt-2">Nos actions aujourd’hui</h2>
            </div>
